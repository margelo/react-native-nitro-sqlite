...
| Type | Shape |
| --- | --- |
| `Transaction` | `execute`, `executeAsync`, `commit(): NitroSQLiteQueryResult`, and `rollback(): NitroSQLiteQueryResult`. The commit and rollback return type is an internal native result declaration. |
